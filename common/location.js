		...
		children: [
			...
			},
			{
				...
				children: [
				  ...
				  { label: '乌兰察布盟', value: '乌兰察布盟' },
				  { label: '伊克昭盟', value: '伊克昭盟' },
				  { label: '巴彦淖尔盟', value: '巴彦淖尔盟' },
			...
			},
			{
			  ...
			  {
				label: '台湾',
				children: [ { label: '台湾', value: '台湾' }, { label: '其他', value: '其他' } ],
				value: '台湾'
			  },
			  {
				label: '澳门',
				children: [ { label: '澳门', value: '澳门' } ],
				value: '澳门'
			  },
			  {
				label: '香港',
				children: [ { label: '香港', value: '香港' } ],
				value: '香港'
			  },
			  {
				label: '钓鱼岛',
				children: [ { label: '钓鱼岛', value: '钓鱼岛' } ],
				value: '钓鱼岛'
			  }        
		]
	}
